...
namespace CapaNegocio
{
    public class CN_Paypal
    {
        ...
        private string urlpaypal = "https://api-m.sandbox.paypal.com" ;
        private string clientId = "AWAwUkkOi7iPUBtwxVyTttIz8YZVpgVS-bGYZBioe8iQgWRxrZFYS4CWiFFVQrds_RBhHZbrV7HSuzcv";
        private string secret = "EFYp1rnpU-7fiIKPXykGKwyCH4ciUOh6SchD8NjbNe02dgzt_YkB2PLUmLIk0zOZK2i3nB--qJOOKTsU";
